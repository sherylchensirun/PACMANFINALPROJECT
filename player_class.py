...
class Player:
    ...
    def on_coin(self):
        if self.grid_pos in self.app.coins:
            #to make sure coin is being removed only when position of player is exactly equals to position of coin
...
#if player moves in a direction of 1 step and hits the wall, player cannot move, else player can move
    def can_move(self):
