...
############################ HELPER FUNCTIONS ##################################
    ...
    def load(self):
        ...
        # To open wall file to creating walls list with co-ords of walls (xidx, yidx)
        # stored as  a vector
        with open("walls.txt", 'r') as file:
            for yidx, line in enumerate(file):
                for xidx, char in enumerate(line):
                    ...
                    #player position is p_pos
                    elif char == "P":
                        self.p_pos = [xidx, yidx]
                   #Enemies start positions
...
########################### INTRO FUNCTIONS ####################################
    ...
    def start_draw(self):
        ...
        self.draw_text('PUSH SPACE BAR TO START', self.screen, [
                       WIDTH//2, HEIGHT//2-50], START_TEXT_SIZE, PLAYER_COLOUR, START_FONT, centered=True)
        self.draw_text('1 PLAYER ONLY', self.screen, [
                       WIDTH//2, HEIGHT//2+50], START_TEXT_SIZE, WHITE, START_FONT, centered=True)
...
########################### PLAYING FUNCTIONS ##################################
    ...
    def playing_draw(self):
        ...
        #draw coins on the screen instead of background so that player can eat the coins
        self.draw_coins()
        # self.draw_grid()
...
########################### GAME OVER FUNCTIONS ################################
    ...
    def game_over_draw(self):
        ...
        self.draw_text("GAME OVER", self.screen, [WIDTH//2, 100],  46, RED, "arial", centered=True)
        self.draw_text(again_text, self.screen, [
                       WIDTH//2, HEIGHT//2],  24, (190, 190, 190), "arial", centered=True)
        self.draw_text(quit_text, self.screen, [
                       WIDTH//2, HEIGHT//1.5],  24, (190, 190, 190), "arial", centered=True)
        pygame.display.update()
