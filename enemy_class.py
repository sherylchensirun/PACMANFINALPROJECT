...
class Enemy:
    def __init__(self, app, pos, number):
        ...
        #before they start they are not going to move
        self.direction = vec(0, 0)
        self.behaviour = self.set_behaviour()
        self.target = None
...
#dimensions of each enemy
    ...
    def set_target(self):
        if self.behaviour == "fast" or self.behaviour == "slow":
